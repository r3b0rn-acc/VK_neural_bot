...
test_sample = ['долбаебушка', 'яблочко', 'пиздатряс', 'каркуша', 'выебляд',
               'уха', 'говночист', 'шалаш', 'пидористический', 'шлюпка',
               'невъебично', 'мандарины', 'пиздастрадалец', 'именины',
               'еблотряс', 'юбилей', 'дыркоеб', 'отбеливающее', 'мандавошка',
               'разглядка', 'блядовать', 'гребля', 'хуестрадалица', 'эдик',
               'ебалыга', 'мангуст', 'ебень', 'копчик', 'изъебистый', 'внук',
               'хуевост', 'хвост', 'блядственная', 'зубочист', 'выебон', 'выхухоль']
